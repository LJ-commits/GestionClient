"""
Django settings for GestionClient project.
...
DEBUG = False       # False if in production
...
WSGI_APPLICATION = 'GestionClient.wsgi.application'
...
LANGUAGE_CODE = 'fr-fr'  # <--- MODIFIÉ POUR LE FRANÇAIS

TIME_ZONE = 'Europe/Brussels'  # <--- AJOUTÉ POUR UN FUSEAU HORAIRE FRANÇAIS OU BELGE (Namur)

USE_I18N = True

USE_TZ = True

# Ajout du chemin pour les fichiers de traduction personnalisés
LOCALE_PATHS = [
...
# --- AJOUTS/MODIFICATIONS POUR L'AUTHENTIFICATION ---

# Indique à Django quel modèle utiliser pour l'authentification
AUTH_USER_MODEL = 'gestion.Utilisateur'

# Où rediriger après une connexion réussie
LOGIN_REDIRECT_URL = 'home'

# L'URL de votre page de connexion
LOGIN_URL = 'login'

# Où rediriger après une déconnexion
